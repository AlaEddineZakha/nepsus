...
class LigneBCC
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\BonCommandeClient", inversedBy="ligne")
     */
    private $bc;
    /**
     * @var \Doctrine\Common\Collections\Collection|Produit[]
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Produit", inversedBy="ligne")
     */
    private $produit;
    /**
